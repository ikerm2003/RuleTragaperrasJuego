...
def test_core_modules():
    ...
    try:
        ...
        # Test config system
        from config import Language, config_manager, get_text
...
def test_poker_module():
    ...
    try:
        ...
        from poker_logic import GamePhase, PlayerAction
        ...
        try:
            ...
            if "relative import" in str(table_e):
                print(
                    "  ⚠️  Poker table import issue (relative import - normal in test environment)"
                )
            else:
                raise table_e
